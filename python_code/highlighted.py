...
def hide_not_highlighted_text(path_to_file_with_name, file_name):
...
#                 pass
    ...
    def iterate_footer_header(footer_or_header):
        ...
        """
        utils_py.log_in_file(f"HIGHLIGHTED: iterate_footer_header {footer_or_header}")
...
#     hide_not_highlighted_text(elements_list)
    ...
    for section in document.sections:
        utils_py.log_in_file(f"HIGHLIGHTED: iterating through sections")
